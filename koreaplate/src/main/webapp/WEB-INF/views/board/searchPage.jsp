	...
	<main class="mn-toplist pg-toplist">
		<article class="contents">
			...
			<div class="container-list" id="contents_width">
				<div class="inner">
					<div class="ad_area right_space only-desktop" id="web_desktop-toplist-right_space">
						<div class="ad_wrap">
							<div class="content" id="web_desktop-toplist-right_space-content" data-google-query-id="CLHRvJ3bweoCFQWewgody_MIow">
								<div id="google_ads_iframe_/395211568/alpha/desktop-web.toplist.right-side_0__container__" style="border: 0pt none; display: inline-block; width: 160px; height: 600px;">
									<iframe frameborder="0" src="https://f431e69df376240d008dc454aec7ffb4.safeframe.googlesyndication.com/safeframe/1-0-37/html/container.html" id="google_ads_iframe_/395211568/alpha/desktop-web.toplist.right-side_0" title="3rd party ad content" name="" scrolling="no" marginwidth="0" marginheight="0" width="160" height="600" data-is-safeframe="true" sandbox="allow-forms allow-pointer-lock allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts allow-top-navigation-by-user-activation" data-google-container-id="3" style="border: 0px; vertical-align: bottom;" data-load-complete="true"></iframe>
								</div>
							</div>
						</div>
					</div>
									...
									<div class="with-review">
										<figure class="restaurant-item">
											...
											<figcaption>
												<div class="info">
													<span class="title ">
														<a href="viewPage?dSaup_no=${list.dSaup_no }" >${index.count }.<h3>${list.dName}</h3></a>
													</span>
													<strong class="point "><span>${list.dRating}</span></strong>
