		...
		<form class="form-horizontal" id="loginForm" role="form" method="post"enctype="multipart/form-data">
			<div class="form-group" id="divId">
				...
				<c:if test="${dDTO.dAccpet eq '0' }">
					<h2 style="color:red; margin-left: 20px;">가입승인 대기중입니다. 관리자 승인을 기다려 주세요.</h2>
				</c:if>
				...
				<div class="check-font" id="id_check">
					...
					<div id="pwUpdate" class="pw_font">
						기존 비밀번호 입력 <br/><input type="password" placeholder="기존 비밀번호 입력" id="dPw" name="dPw" /><br/>
    					새로운 비밀번호 입력 <br/><input type="password" placeholder="새로운 비밀번호 입력" id="dPwUpdate" name="dPwUpdate" /><br/>
						새로운 비밀번호 확인 <br/><input type="password" placeholder="비밀번호 확인" id="dPwCheck" name="dPwCheck" /><br/>
		...
		$(function(){
			...
			<div class="form-group">
				<div class="col-lg-offset-2 col-lg-10">
					<c:if test="${dDTO.dNo eq null }"><input type="button" value="승인 요청하기." class="btn btn-primary" onclick="fn_multiUpload(this.form)" /></c:if>
					<c:if test="${dDTO.dNo ne null }"><input type="button" value="정보 수정하기." class="btn btn-primary" onclick="fn_multiUpload(this.form)" /></c:if>
