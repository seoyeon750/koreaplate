			...
			<div class="form-group" id="divId">
                ...
                <div class="check-font" id="id_check">
                    ...
                    <div id="pwUpdate" class="pw_font">
                    	기존 비밀번호 입력 <br/><input type="password" placeholder="기존 비밀번호 입력" id="cPw" name="cPw" /><br/>
                    	새로운 비밀번호 입력 <br/><input type="password" placeholder="새로운 비밀번호 입력" id="cPwUpdate" name="cPwUpdate" /><br/>
                    	새로운 비밀번호 확인 <br/><input type="password" placeholder="비밀번호 확인" id="cPwCheck" name="cPwCheck" /><br/>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <select class="form-control" id="gender" name="cGender">
                    	<c:if test="${cDTO.cGender eq '1' }"><option value="1">남</option></c:if>
                    	<c:if test="${cDTO.cGender eq '2' }"><option value="2">여</option></c:if>
                    </select>
                </div>
            </div>
            <div>
								...
								<c:forEach var="rDTO" items="${list }" varStatus="name">
									<tr id="review" data-remote="reviewDetail?rNo=${rDTO.rNo}"data-toggle="modal" data-target="#Modal">
										...
										<td>
											...
											<c:if test="${fn:length(content) > 35 }">${fn:substring(content,0,35) }...</c:if>
											<c:if test="${fn:length(content) < 35 }">${rDTO.rContent }</c:if>
										</td>
