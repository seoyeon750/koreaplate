				...
				$.ajax({
		               ...
		               success: function(data) {		    
		                   switch (data) {
		                       ...
		                       case 1:
		                       		alert('자동 가입 방지 봇을 체크해주세요.'); break;
		                       default:
		                       		alert("자동 가입 방지 봇을 실행 하던 중 오류가 발생 했습니다. [Error bot Code : " + Number(data) + "]"); break;
		                   }
		               }
		           });
			});
				...
				$.ajax({
		               ...
		               success: function(data) {
		                   switch (data) {
		                       ...
		                       case 1:
		                       		alert('자동 가입 방지 봇을 체크해주세요.'); return false; break;
		                       default:
		                           alert("자동 가입 방지 봇을 실행 하던 중 오류가 발생 했습니다. [Error bot Code : " + Number(data) + "]"); break;
		                   }
		               }
		...
		<div class="customerWrap" style="width:20rem; border-radius:20px;">
			...
			<div class="card-body">
				<form class="form-signin" method="POST">
					...
					<div class="checkbox">
						<label><input type="checkbox" value="true" id="saveIDCheck" name="saveIDCheck"> 아이디 기억하기</label>
					</div>
		...
		<div class="departmentWrap" style="width:20rem; border-radius:20px;">
			...
			<div class="card-body">
				<form class="form-signin" method="POST" onSubmit="logincall();return false">
					...
					<div style="text-align: center;">
	       				<a href="findDeptIdPw">아이디 / 비밀번호 찾기</a>&nbsp;&nbsp;&nbsp;&nbsp;
